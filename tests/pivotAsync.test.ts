...
describe("Error Handling", () => {
  ...
  it("Returns an error when the classifier returns an error", async () => {
    const result = await accumulateAsync([1, 2, 3])
      .pivot({
  ...
  it("Returns an error when the classifier throws an error", async () => {
    const result = await accumulateAsync([1, 2, 3])
      .pivot({
        classifier: () => {
          throw new Error("No way!");
  ...
  it("Throws an error when the classifier returns an error", async () => {
    await expect(async () => {
      await accumulateAsync([1, 2, 3])
        .enableExceptions()
        .pivot({
  ...
  it("Throws an error when the classifier throws an error", async () => {
    await expect(async () => {
      await accumulateAsync([1, 2, 3])
        .enableExceptions()
        .pivot({
...
describe("Pivots a small number of values", () => {
  it("Pivots three rows into one", async () => {
    const result = await accumulateAsync([1, 2, 3])
      .pivot({
        reducer: (a, b) => a + b,
        valueName: "val",
  ...
  it("Pivots three rows into three", async () => {
    const result = await accumulateAsync([1, 2, 3])
      .pivot({
        reducer: (a, b) => a + b,
        valueName: "val",
  ...
  it("Pivots seven rows into three", async () => {
    const result = await accumulateAsync([1, 2, 3, 4, 5, 6, 7])
      .pivot({
        reducer: (a, b) => a + b,
        valueName: "val",
